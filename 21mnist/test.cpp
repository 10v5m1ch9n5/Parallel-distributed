...
int main() {
    ...
    std::cout << _mm512_reduce_add_ps(_mm512_mul_ps(tens1.V(0,0,0,0),tens2.V(0,0,0,0))) << std::endl;
    ...
    std::cout << _mm512_reduce_add_ps(_mm512_mul_ps(tens3.V(0,0,0,0),tens4.V(0,0,0,0))) << std::endl;
